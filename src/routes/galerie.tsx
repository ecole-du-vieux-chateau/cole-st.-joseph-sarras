...
const PHOTOS: { src: string; alt: string; category: Exclude<Category, "Tout"> }[] = [
  { src: facadeVieuxChateauAsset.url, alt: "La façade en pierre de l'École du Vieux Château", category: "L'école vide" },
  ...
  { src: facadeAsset.url, alt: "La façade de l'école du Vieux Château", category: "L'école vide" },
  { src: courAsset.url, alt: "La cour de récréation et son préau", category: "L'école vide" },
  { src: hallAsset.url, alt: "Le hall d'entrée décoré par les élèves", category: "L'école vide" },
  { src: salleActivitesAsset.url, alt: "Le coin lecture et jeux calmes", category: "L'école vide" },
  { src: cantineEcoleAsset.url, alt: "La salle de cantine décorée", category: "L'école vide" },
  { src: salleRepasAsset.url, alt: "L'espace repas et coin cuisine", category: "L'école vide" },
  { src: salleInfoAsset.url, alt: "La salle informatique de l'école", category: "L'école vide" },
  { src: salleInfoEnfantsAsset.url, alt: "Les élèves à la salle informatique", category: "Vie de l'école" },
  { src: salleReposMaterAsset.url, alt: "L'espace repos et vestiaires en maternelle", category: "L'école vide" },
  { src: classeMater1Asset.url, alt: "Classe maternelle avec coins jeux et apprentissages", category: "L'école vide" },
  { src: classeMater2Asset.url, alt: "Coin activités et affichages en maternelle", category: "L'école vide" },
  { src: classeMater3Asset.url, alt: "La salle de motricité et de regroupement en maternelle", category: "L'école vide" },
  { src: classeMater4Asset.url, alt: "La grande salle de classe de maternelle", category: "L'école vide" },
  { src: tableauClasseAsset.url, alt: "Le tableau des règles de vie de la classe", category: "L'école vide" },
  { src: classeElem1Asset.url, alt: "Salle de classe élémentaire avec bureaux et tableau", category: "L'école vide" },
  { src: classeElem2Asset.url, alt: "Classe élémentaire lumineuse et organisée", category: "L'école vide" },
  { src: classeElem3Asset.url, alt: "Espace de travail des cycles 2 et 3", category: "L'école vide" },
