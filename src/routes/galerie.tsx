...
const PHOTOS: { src: string; alt: string; category: Exclude<Category, "Tout"> }[] = [
  { src: facadeVieuxChateauAsset.url, alt: "La façade en pierre de l'École du Vieux Château", category: "Les espaces de l'école" },
  ...
  { src: facadeAsset.url, alt: "La façade de l'école du Vieux Château", category: "Les espaces de l'école" },
  { src: courAsset.url, alt: "La cour de récréation et son préau", category: "Les espaces de l'école" },
  { src: hallAsset.url, alt: "Le hall d'entrée décoré par les élèves", category: "Les espaces de l'école" },
  { src: salleActivitesAsset.url, alt: "Le coin lecture et jeux calmes", category: "Les espaces de l'école" },
  ...
  { src: classeMater3Asset.url, alt: "La salle de motricité et de regroupement en maternelle", category: "Les espaces de l'école" },
  { src: classeMater4Asset.url, alt: "La grande salle de classe de maternelle", category: "Les espaces de l'école" },
  { src: tableauClasseAsset.url, alt: "Le tableau des règles de vie de la classe", category: "Les espaces de l'école" },
  { src: classeElem1Asset.url, alt: "Salle de classe élémentaire avec bureaux et tableau", category: "Les espaces de l'école" },
